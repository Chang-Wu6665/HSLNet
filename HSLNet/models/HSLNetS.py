...
import math
from HSLNet.moblievit_star import mobile_vit_small
...
class pvt(nn.Module):
    def __init__(self, norm_layer=nn.LayerNorm):
        ...
        self.fusion1 = SMFM(160, 12, 12)
        self.fusion2 = SMFM(128, 24, 24)
        self.fusion3 = SMFM(96, 48, 48)
        self.fusion4 = SMFM(64, 96, 96)
        ...
        self.hff1 = HIRM(in_ch=64, out_ch=64)
        self.hff2 = HIRM(in_ch=64, out_ch=64)
        self.hff3 = HIRM(in_ch=64, out_ch=64)
        self.hff4 = HIRM(in_ch=64, out_ch=64)

        self.fe_12 = MFEM(160, 64)
        self.fe_24 = MFEM(128, 64)
        self.fe_48 = MFEM(96, 64)
        self.fe_96 = MFEM(64, 64)
